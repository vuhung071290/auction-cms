...
const property = (state = initialState, action) => {
    switch (action.type) {
        case Action.PROPERTY_LIST_INIT:
            const { list, total, page, size } = action;
            return { ...state, list, total, page, size };
        case Action.PROPERTY_LIST_LOADING:
            return { ...state, loading: action.status };
        case Action.PROPERTY_SEARCH_CHANGE:
            return { ...state, search: action.search };
        case Action.PROPERTY_DATE_CHANGE:
            return { ...state, startDateSearch: action.startDateSearch, endDateSearch: action.endDateSearch };
        case Action.PROPERTY_PAGE_CHANGE:
            return { ...state, page: action.page };
        case Action.PROPERTY_SIZE_CHANGE:
